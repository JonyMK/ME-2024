...
# X - Diâmetro interno de um segmento de um motor de automóvel, em cm.
# X ~ N(μ, σ) => Normal
# μ = 10m
# σ = 0.03m
# X ~ N(10, 0.03)
...
# X - Temperatura diária de uma sala de espera, em graus centígrados.
# X ~ N(μ, σ) => Normal
# μ = ?
# σ = 2 graus
# X ~ N(μ, 2)
...
# X - Comprimento do salto dado pelo atleta.
# X ~ N(μ, σ) => Normal
# μ = 7.23m
# σ = 0.33m
# X ~ N(7.23, 0.33)
...
# P(7 < X < 7.5) = 
# F(7.5) - F(7) =
# pnorm(7.5, 7.23, 0.33) - pnorm(7, 7.23, 0.33) =
# 0.5505
...
# Y - Nº de saltos com comprimento maior que 7.55m, em 5 saltos.
# Y ~ B(n, p)
# n = 5
# p = P(X > 7.55) = 1 - F(7.55) = 1 - pnorm(7.55, 7.23, 0.33) = 0.2066
# Y ~ B(5, 0.2066)

# P(Y = 2) = dbinom(2, 5, 0.2066) = 0.2132
...
# T = X1 + X2 + X3 ~ N(7.2 + 7.1 + 6.9, sqrt(0.3^2 + 0.36^2 + 0.1^2))
# T = X1 + X2 + X3 ~ N(21.2, sqrt(0.2296))

# P(T > 21.3) =
# 1 - P(T <= 21.3) =
# 1 - F(21.3) =
# 1 - pnorm(21.3, 21.2, sqrt(0.2296)) =
# 0.4173
...
# X.A - Peso dos moldes de madeira.
# X.A ~ N(20, 1.4)

# X.B - Peso do pelo sintético.
# X.B ~ N(1.8, 0.12)

# X.C - Peso dos olhos, nariz e língua.
# X.C ~ N(0.2, 0.03)

# P(X1 + X2 + X3 > 21) = ?

# Y - Peso total do cão de madeira.
# Y ~ N(μ, σ) => Normal
# μ = μ.X.A + μ.X.B + μ.X.C = 20 + 1.8 + 0.2 = 22
# σ = σ.X.A + σ.X.B + σ.X.C = 1.4 + 0.12 + 0.03 = 1.55 ???????????????
# σ = σ.X.A + σ.X.B + σ.X.C = sqrt(((1.4)^2) + ((0.12)^2) + ((0.03)^2)) = 1.4055
# Y ~ N(22, 1.4055)
...
# X - Notas de estatística obtidas numa faculdade.
# X ~ N(μ, σ) => Normal
# μ = 10
# σ = ?
# X ~ N(10, σ)
...
# Y - Nº de alunos com nota superior a 8, em 10 alunos.
# Y ~ B(n, p)
# n = 10
# p = P(X > 8) = 1 - F(8) = 1 - pnorm(8, 10, 2.0004) = 0.8413
# Y ~ B(10, 0.8413)

# P(Y = 4) = dbinom(4, 10, 0.8413) = 0.0017
